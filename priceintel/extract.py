...
def availability_state(value):
    ...
    in_tokens = (
        ...
        "відвантаження зі складу", "отгрузка со склада", "відправка зі складу",
        "готовий до відправки", "available", "доступний", "доступен",
    )
...
def extract_product(html: str, url: str):
    ...
    if not availability:
        low_text = text.lower()
        for phrase in ("готово до відправки", "готовий до відправки", "відвантаження зі складу", "відправка зі складу", "є в наявності", "в наявності", "готов к отправке", "отгрузка со склада", "есть в наличии", "в наличии", "немає в наявності", "нет в наличии"):
